...
import static Utiles.MetodosUtiles.MetodosParaManipularMisClases.comprobarStringOperando;
import static Utiles.MetodosUtiles.MetodosParaManipularMisClases.comprobarStringRespuestaCola;
...
//        ex.printStackTrace();
//    }
     public static void showDialogError(String contenido,String titulo){
    ...
    public static void responerException(Exception ex) {
        ...
        mensajesError=new String[]{"Error Interno","Error"};
        }
        showDialogError(mensajesError[0], mensajesError[1]);
//        if (ex instanceof NoEncontradoException || ex instanceof PINException
//                || ex instanceof ExisteException || ex instanceof NoPermitidoException
//                || ex instanceof IndiceFinalIncorrectoException || ex instanceof IndiceIncorrectoException
//                || ex instanceof IndiceInicialIncorrectoException) {
